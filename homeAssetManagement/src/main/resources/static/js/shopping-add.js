	   ...
	   $(function(){
		   ...
		   form.submit(function( event ) {
			   ...
			   if($("#unitPrice").val().trim()==""){
				   $("#unitPrice").nextAll(".invalid-feedback").text("单价是必须的！");
				   i++;
			   }
			   ...
			   if($("#unitOfPrice").val().trim()==""){
				   $("#unitOfPrice").nextAll(".invalid-feedback").text("请输入单位，例如：Euro/kg Eruo/L");
				   i++;
			   }
			   if($("#taxType :selected").val()==""){
				   $("#taxType").nextAll(".invalid-feedback").text("请选择税率类型");
				   i++;
			   }
			   if($("#coupon").val().trim()==""){
